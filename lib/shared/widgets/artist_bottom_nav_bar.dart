...
class ArtistBottomNavBar extends StatefulWidget {
  const ArtistBottomNavBar({super.key});

  @override
  State<ArtistBottomNavBar> createState() => _ArtistBottomNavBarState();
}

class _ArtistBottomNavBarState extends State<ArtistBottomNavBar> {
            ...
            children: [
              ...
              GestureDetector(
                ...
                child: SizedBox(
                  height: 70,
                  width: 74.94,
                  child: Image.asset(ImageAssetConstant.artistNavBarImage),
                ),
              ),
              BottomBarMenu(
                selectedSvg: SvgImageAssetConstant.promotionIcon,
                unselectedSvg: SvgImageAssetConstant.promotionIcon,
                name: 'Promotions',
