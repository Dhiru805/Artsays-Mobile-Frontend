...
import 'package:artsays_app/home_social/profileTabBar/widget/custom_slider_container_artist_my_account.dart';
...
class SocialProfileArtistMyAccount extends StatefulWidget {
  ...
  @override
  State<SocialProfileArtistMyAccount> createState() =>
      _SocialProfileArtistMyAccountState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomSheet: BottomSheet(
        ...
        builder: (context) {
          return CustomSliderContainerArtistMyAccount();
        },
      ),
    );
  }
