...
class CustomSlderContainerProfileJoin extends StatefulWidget {
  final VoidCallback? onAddTap;
  const CustomSlderContainerProfileJoin({super.key, this.onAddTap});

  @override
  State<CustomSlderContainerProfileJoin> createState() =>
      _CustomSliderContainerState();
}

class _CustomSliderContainerState extends State<CustomSlderContainerProfileJoin>
