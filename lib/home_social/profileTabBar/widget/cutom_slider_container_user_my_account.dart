...
class CutomSliderContainerUserMyAccount extends StatefulWidget {
  const CutomSliderContainerUserMyAccount({super.key});

  @override
  State<CutomSliderContainerUserMyAccount> createState() =>
      _CustomSliderContainerState();
}

class _CustomSliderContainerState
    extends State<CutomSliderContainerUserMyAccount>
