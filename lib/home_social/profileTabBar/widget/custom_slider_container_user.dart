...
class CustomSliderContainerUser extends StatefulWidget {
  const CustomSliderContainerUser({super.key});

  @override
  State<CustomSliderContainerUser> createState() =>
      _CustomSliderContainerUserState();
}

class _CustomSliderContainerUserState extends State<CustomSliderContainerUser>
